...
namespace KingWoW
{
    public class FireMageSettings : Settings
    {
        public static FireMageSettings Instance = new FireMageSettings();

        public string path_name = Path.Combine(Styx.Common.Utilities.AssemblyDirectory, string.Format(@"KingWOWCurrentSettings/FireMage/FireMage-Settings-{0}.xml", StyxWoW.Me.Class.ToString()));

        public FireMageSettings()
            : base(Path.Combine(Styx.Common.Utilities.AssemblyDirectory, string.Format(@"KingWOWCurrentSettings/FireMage/FireMage-Settings-{0}.xml", StyxWoW.Me.Class.ToString())))
        {
        }
        ...
        [Category("Settings COMBUSTION")]
        [DisplayName("Combustion Use")]
        ...
        [DefaultValue(20000)]
        [Category("Settings COMBUSTION")]
        [DisplayName("MinIgniteForCombustion")]
